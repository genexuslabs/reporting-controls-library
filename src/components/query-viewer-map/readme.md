...
| `series`           | --                   | Series options for specific data and the data itself.                                                           | `SeriesOptionsType[]`                                                                                                                                                                                                                  | `undefined` |
...
| `mapItemUnSelect` |             | `CustomEvent<(this: Point, event: PointInteractionEventObject) => void>` |
